...
import { noChangeParts } from "@/utils/constants"
...
type ModelMacbook16Props = JSX.IntrinsicElements["group"]

export const ModelMacbook16 = (props: ModelMacbook16Props) => {
  const { nodes, materials, scene } = useGLTF("/models/macbook-16-transformed.glb") as unknown as GLTFResult
  const texture = useTexture("/images/root/screen.png")
